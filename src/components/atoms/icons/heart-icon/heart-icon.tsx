...
const HeartIconSvGComponent: FC<SvgIcon> = ({ variant, color, hoverColor, size }) => {
  return variant === 'filled' ? (
    <svg
      ...
      className={`fill-${color} - hover:fill-${hoverColor ?? color} - group-hover:fill-${hoverColor ?? color}`}
    >
